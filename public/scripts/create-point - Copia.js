...
const collectedItems = document.querySelector('input[name=itens]') //Procura no HTML um elemento select com name itens e add a const
...
function handleSelectedItem(event) { //Criação de função
    ...
    const alreadySelected = selectedItems.find( (item) => { //Criação de constante que irá procurar o index,
